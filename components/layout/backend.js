        ...
        firebase.auth().onAuthStateChanged(user => {
            if (user) {
                ...
                firebase.database().ref('users/' + user.uid).on('value', s => {
                    ...
                    if (!userData.admin) {
                        const passwords = ['gppcr1966', 'gppcroshodi1234']
    ...
    render() {
        ...
        return (
            <div className={[classes.wrapper, this.state.showSidenav ? classes.show : ''].join(" ")} >
                <Head>
                    <title>Admin | GPPCR </title>
                    <link rel="shortcut icon" href="/img/logo/gppcr-logo.png" />
                </Head>
                ...
                <div className={classes.Sidenav}>
                    <h1>
                        <img alt="" src="/img/logo/gppcr-logo.png" />
                        <strong className="pl-3 d-inline-block ">GPPCR </strong>
                    </h1>
                    ...
                    <Link activeClassName={classes.active} href="/admin/pc">
                        <a className={classes.sidenavLink} >
                            <i className="fal fa-play mr-1"></i> PraiseChallenge
                        </a>
                    </Link>

                    <Link activeClassName={classes.active} href="/admin/tv">
                        <a className={classes.sidenavLink} >
                            <i className="fal fa-play mr-1"></i> GPPCR tv
                        </a>
                    </Link>
                    <Link activeClassName={classes.active} href="/admin/ministers-desk">
                        <a className={classes.sidenavLink} >
                            <i className="material-icons mr-1">desktop_windows</i> Ministers Desk
                        </a>
                    </Link>

...
export default class Home extends Component {
  ...
  render() {
    return (
      <Layout
        bg={this.state.bg}
        title="Home | GPPCR great physician pentecostal church of redeemer"
      >
        <header>
          ...
          <div className="container ">
            <div className="row height-90 align-items-center  text-white">
              <div
                className="col-md-12 col-lg-8 text-center text-lg-left pt-5 wow slideInLeft "
                data-wow-duration="1.5s"
              >
                <h1 className="text-capitalize h2 text-center text-lg-left  ">
                  Great physician pentecostal church of redeemer
                  <small>
                    GPPCR <small className="h5">Oshodi</small>
                  </small>
                </h1>
                <p>solution centre</p>
                <p>
                  ...
                  <a href="https://chat.whatsapp.com/BwjhzBKvWDA9FpDSGctxlu">
                    <i className="fab fa-whatsapp fa-2x mx-3  text-success"></i>
                  </a>
                  <a href="https://www.youtube.com/channel/UCsuHF_CqyVjBYozRSG9sx-g">
                    <i className="fab fa-youtube fa-2x  text-red"></i>
                  </a>
                  <Link href="/gppcr-tv">
                    <a className="btn btn-danger">GPPCR TV</a>
                  </Link>
                </p>
              </div>
              <div
                className=" col-4 d-none d-lg-flex wow slideInRight"
                data-wow-duration="1.5s"
              >
                <img
              ...
              <div className="spin-icon wow bounce slower infinite">
                <a href="#footer">
                  <i
                    href="#footer"
                    className="text-white fa-2x fa fa-arrow-down "
                  ></i>
                </a>
              </div>
            </div>
          ...
          <div class="container mt-5">
            ...
            <div class="row pt-5">
              <div class=" col-md-6 pr-md-5 pb-5 wow slideInLeft">
                ...
                <p>
                  to our church - GPPCR invites you to look around and get a
                  feel for our church. Feel free to share any comments or
                  questions that might be on your mind through our online guest
                  book. If you're not currently a member of our church - we'd
                  like to take this opportunity to invite you to one of our
                  <a href="#weekly" class="text-success">
                    weekly opportunities
                  </a>
                  And of course, feel free to reach out and call one of our
                  <a href="#ministers" class="text-success">
                ...
                <h4 class="text-capitalize font-weight-bold">
                  <small class="font-weight-bold">
                    <i class="fas fa-utensils mr-3 fa-2x"></i> made just for you
                  </small>
                </h4>
                <p>
                  We hope you and your family will have a warm and spirit-filled
                  experience with us as we worship and fellowship together at
                ...
                <h4 class="text-capitalize font-weight-bold">
                  <small class="font-weight-bold">
                    <i class="far mr-3 fa-heart fa-2x"></i>Let us pray
                  </small>
                </h4>
                <p>
                  We'd also like to invite you to make an
                  <a href="./html/prayer.html" class="text-success">
                    online prayer request.
                  </a>
                  Your prayer request opens the door, and God is waiting
                  patiently on the other side of that door, at all times, in all
                  situations, to join with you
                </p>
              </div>
              <div class="col-md-6 pl-md-5  wow slideInRight">
                <h2 class="text-capitalize text-center pb-5">
                  what we believe
                </h2>
                <p>
                  At GPPCR, believe the Bible to be the inspired, the only
                  infallible, authoritative Word of God and inerrant in the
                  original writings. We believe that there is one God, eternally
                  existing in three persons: Father, Son, and Holy Spirit. We
                  believe in the deity of our Lord Jesus Christ, in His virgin
                ...
                <br />
                <p>
                  We believe that the lost and sinful man must be saved, and
                  that man's only hope of redemption is through the shed blood
                  of Jesus Christ, the Son of God. We believe in and practice
                  the holy ordinance of water baptism, which signifies the
                  believer's death, burial, and resurrection into new life with
                  Christ Jesus, and the regular celebration of Holy Communion as
            ...
            <div class="row py-5">
              <div class="col d-flex justify-content-center">
                <div>
                  Check out
                  <Link href="/gppcr-tv">
                    <a class="pl-4 btn btn-outline-danger mx-auto btn-lg rounded-pill">
                      Go to GPPCT tv
                    </a>
                  </Link>
                </div>
        ...
        <section id="gatherings" class="bg-dark">
          <div class="container text-center py-5 text-light">
            ...
            ></iframe>
            <small>
              <a href="https://mixlr.com/gppcr-radio">GPPCR on Mixlr</a>
            </small>
          </div>
        </section>
          ...
          <div class="container-fluid text-center  py-5">
            ...
            <div class="row pb-5 justify-content-around">
              ...
              <div class="col-12 col-sm-6 col-md-4 col-lg-3 py-3">
                <div class="wow slideInDown mx-auto mb-4 text-white icon bg-warning d-flex align-items-center justify-content-center">
                  <i class="far fa-lightbulb fa-2x"></i>
                </div>
                <h4>
                  <i class="fas fa-sun fa-1x  "></i>Sunday
                </h4>
              ...
              <div class="col-12 col-sm-6 col-md-4 col-lg-3 py-3">
                <div class="wow slideInUp mx-auto mb-4 text-white icon bg-warning d-flex align-items-center justify-content-center">
                  <i class="fa fa-church fa-2x"></i>
                </div>
                <h4>
                  <i class="fas fa-sun fa-1x  "></i>Tuesday
                </h4>
                <p class="font-weight-light">
              ...
              <div class="col-12 col-sm-6 col-md-4 col-lg-3 py-3">
                ...
                <h4>
                  <i class="fas fa-sun fa-1x  "></i>Wednesday
                </h4>
                <p class="font-weight-light">
                  Bible study <br />
                  (6:00pm to 8:00pm)
              ...
              <div class="col-12 col-sm-6 col-md-4 col-lg-3 py-3">
                ...
                <h4>
                  <i class="fas fa-sun fa-1x  "></i>Friday
                </h4>
                <p class="font-weight-light">
                  Prayer meeting <br />
                  (6:00pm to 7:00pm
            ...
            <div class="row pb-5 justify-content-around">
              ...
              <div class="col-12 col-sm-6 col-md-3 py-3">
                <div class="icon wow slideInUp mx-auto mb-4 text-white  bg-warning d-flex align-items-center justify-content-center">
                  <i class="far fa-calendar-alt fa-2x"></i>
                </div>
                <h4 class="text-capitalize h5">
            ...
            <div class="row text-center">
              <div class="col">
                ...
                <Link href="html/events.html">
                  <a class="btn mx-3 btn-danger ">events page</a>
                </Link>
                for more
              </div>
            </div>
          ...
          <div class="container py-5">
            ...
            <div class="row justify-content-around">
              <div class="col-md-6 col-lg-4 py-2 wow slideInRight">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <Link href="ministers">
                      <a class="btn btn-outline-warning text-uppercase">
                        press here
                      </a>
                    </Link>
                  </div>
                  <div class="card-footer bg-secondary d-flex justify-content-around ">
                    <a href="https://www.facebook.com/greatphysicianpentecostaloshodi/">
                      <i class="fab text-white  fa-2x fa-facebook"></i>
                    </a>
                    <a href="https://chat.whatsapp.com/BwjhzBKvWDA9FpDSGctxlu">
                      <i class="fab text-white fa-2x fa-whatsapp"></i>
                    </a>
                    <a href="https://www.youtube.com/channel/UCsuHF_CqyVjBYozRSG9sx-g">
              ...
              <div class="col-md-6 py-2 col-lg-4  wow slideInLeft">
                <div class="card">
                  <img
                    src="img/ministers/oluwakemi.jpg"
                    alt="ministers"
                    class="card-img-top"
                  />
                  <div class="card-body">
              ...
              <div class="col-md-6 col-lg-4 py-2 wow slideInLeft">
                <div class="card">
                  <img
                    src="img/ministers/funmi.jpg"
                    alt="ministers"
                    class="card-img-top"
                  />
                  <div class="card-body">
                    <div class="card-title text-capitalize">
                      Deaconess Funmilayo Agidee
                    </div>
                    <p class="card-text">
            ...
            <div class="row text-center mt-5">
              <div class="col">
                You can Check out our
                <Link href="/ministers">
                  <a class="btn mx-3 btn-danger ">Ministers Desk</a>
                </Link>
